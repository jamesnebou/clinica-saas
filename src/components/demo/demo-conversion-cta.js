  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 max-w-[calc(100vw-2rem)] rounded-2xl border border-white/10 bg-[#111315]/95 p-3 text-white shadow-[0_24px_80px_rgba(0,0,0,0.42)] backdrop-blur-xl sm:bottom-6 sm:right-6">
      ...
      <div className="flex gap-2">
        <Link href="/auth/leave-demo?next=%2Fcadastro" onClick={() => trackMarketingEvent("signup_click", { location: "demo_dashboard" })} className="inline-flex h-10 items-center gap-2 rounded-full bg-orange-400 px-4 text-xs font-black text-[#1c1c1c]"><Sparkles size={15} /> Criar minha clínica</Link>
