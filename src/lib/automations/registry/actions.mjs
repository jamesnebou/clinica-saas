...
const ACTIONS = {
  ...
  "communication.send_whatsapp": { type: "communication.send_whatsapp", label: "Enviar WhatsApp", module: "Comunicação", capability: "whatsapp", risk: "MEDIUM", parameters: [parameter("template_purpose", "Template oficial", "enum", true, { options: ["booking_created", "booking_payment_pending", "payment_confirmed", "payment_expiring", "payment_expired", "appointment_reminder_24h", "appointment_reminder_3h", "booking_cancelled", "booking_rescheduled"] })] },
...
export const ACTION_REGISTRY = Object.freeze(Object.fromEntries(
  Object.entries(ACTIONS).map(([type, definition]) => [type, Object.freeze({
    ...definition,
    executor: type,
    idempotency: "run_step",
  })]),
));
